 ...
 const [isRecording, setIsRecording] = useState(false);
  ...
  async function loadLabeledImages() {
     ...
     navigator.mediaDevices
       ...
       .then((stream) => {
         ...
         mediaRecorder.onstop = () => {
           ...
           authenticateVoice(audioBlob); // Authenticate the voice after recording
         };
   ...
   const authenticateVoice = async () => {
     ...
     formData.append("username", tempAccount.username); // Send only the username

     try {
       const response = await axios.post("/api/authenticate_voice", formData, {
         headers: {
           "Content-Type": "multipart/form-data", // Ensuring proper content-type
         },
       });
    ...
    <div className="h-full flex flex-col items-center justify-center gap-[24px] max-w-[720px] mx-auto">
      <h2 className="text-center text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
        <span className="block text-indigo-600 mt-2">
          Please Scan Your Face or Record Your Voice to Log In.
        </span>
      </h2>
      ...
      <div className="mt-6">
        <button
          ...
          disabled={isRecording || voiceAuthenticated}
        >
